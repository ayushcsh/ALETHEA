...
const Skeleton = () => {
  ...
  return (
    <div
      className="p-8 overflow-hidden bg-black h-full relative flex items-center justify-center">
      <div className="flex flex-row shrink-0 bg-black justify-center items-center gap-2">
